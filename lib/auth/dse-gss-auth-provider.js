 ...
 * @param {String} user The primary / service.
 * @param {String} host The host.
 * @constructor
 */
function DseGssAuthProvider(user, host) {
...
DseGssAuthProvider.prototype.newAuthenticator = function (endpoint, name) {
  return new GssAuthenticator(this._kerberos, this.user, this.host, name);
};
 ...
 * @private
 */
function GssAuthenticator(kerberosModule, user, host, authenticatorName) {
  this.user = user;
  this.authenticatorName = authenticatorName;
  this.client = GssClient.createNew(kerberosModule, user, host);
}
