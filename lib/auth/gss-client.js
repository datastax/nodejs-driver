 ...
 * @constructor
 */
function GssClient(kerberosModule, host, user, service) {
 ...
 * @returns GssClient
 */
GssClient.createNew = function (kerberosModule, host, user, service) {
  return new StandardGssClient(kerberosModule, host, user, service);
};
 ...
 * @constructor
 */
function StandardGssClient(kerberosModule, host, user, service) {
  GssClient.call(this, kerberosModule, host, user, service);
