 ...
 * @constructor
 */
function GssapiClient(kerberosModule, user, service) {
 ...
 */
GssapiClient.createNew = function (kerberosModule, user, service) {
...
function StandardGssClient(kerberosModule, user, service) {
  GssapiClient.call(this, kerberosModule, user, service);
