 ...
 * @param {Client} client
 * @param {QueryOptions} userQueryOptions
 * @param {Function} [rowCallback]
 * @param {Boolean} [logged]
 */
function createQueryOptions(client, userQueryOptions, rowCallback, logged) {
  var profile = client.profileManager.getProfile(userQueryOptions && userQueryOptions.executionProfile) || utils.emptyObject;
  var options = utils.extend({ logged: logged }, client.options.queryOptions, profile, userQueryOptions);
