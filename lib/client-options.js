...
function extend(baseOptions, userOptions) {
  ...
  if (!options.cloud) {
    ...
    validateCloudOptions(options.cloud);
  }
 ...
 * @private
 */
function validateCloudOptions(cloudOptions) {
  if (typeof cloudOptions.secureConnectBundle !== 'string' && typeof cloudOptions.endpoint !== 'string') {
