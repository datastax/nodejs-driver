...
function createQueryOptions(client, userOptions, rowCallback, logged) {
  var profile =
    client.profileManager.getProfile(userOptions && userOptions.executionProfile) || utils.emptyObject;
  ...
  return {
    ...
    readTimeout: ifUndefined3(userOptions.readTimeout, profile.readTimeout, defaultQueryOptions.readTimeout),
    retry: ifUndefined3(userOptions.retry, profile.retry, defaultQueryOptions.retry),
