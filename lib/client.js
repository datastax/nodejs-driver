 ...
 * @property {Boolean} autoPage
 * @property {Buffer|Array} routingKey
 * @property {Array} routingIndexes
 */
 ...
 * @param [options]
 * @param {function} rowCallback, executes rowCallback(n, row) per each row received. (n = index)
 ...
 * @param {Error} err
 * @param {{rows: Array, meta: Object}} result
 */
