...
Client.prototype.connect = function (callback) {
  ...
  this.controlConnection.init(function (err) {
    ...
    self._selectTokenizer(self.controlConnection.partitioner);
 ...
 * @returns {HostMap}
 */
Client.prototype.getReplicas = function (token) {
  //TODO: Implement
  return null;
};
...
Client.prototype._selectTokenizer = function (partitionerName) {
