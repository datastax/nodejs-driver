  ...
  utils.series([
    ...
    function sendingQuery(next) {
      var request = new requests.QueryRequest(
        ...
        params,
        options);
      var handler = new RequestHandler(self, options.loadBalancing, options.retry);
...
Client.prototype._sendBatch = function (queries, options, callback) {
  ...
  var handler = new RequestHandler(this, options.loadBalancing, options.retry);
...
Client.prototype._getPrepared = function (query, options, callback) {
  ...
  var handler = new RequestHandler(this, options.loadBalancing, options.retryPolicy);
