 ...
 *   Default: true.
 * </p>
 * @property {Object.<string, ExecutionProfile>} profiles A dictionary of name keys and {@link ExecutionProfile}
 * values.
 */
...
Client.prototype.execute = function () {
  ...
  args.options = clientOptions.createQueryOptions(this, args.options);
...
Client.prototype.eachRow = function () {
  ...
  args.callback = utils.bindDomain(args.callback);
  args.options = clientOptions.createQueryOptions(this, args.options, utils.bindDomain(rowCallback));
  var self = this;
  function nextPage() {
...
Client.prototype.batch = function () {
  ...
  args.callback = utils.bindDomain(args.callback);
  args.options = clientOptions.createQueryOptions(this, args.options, null, true);
  var self = this;
