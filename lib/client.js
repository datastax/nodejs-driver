...
Client.prototype.execute = function () {
  ...
  this.connect(function (err) {
    ...
    var request = new requests.QueryWriter(
      args.query,
      args.params,
      args.options);
...
Client.prototype.executeAsPrepared = function (query, params, options, callback) {
  ...
  async.waterfall([
    ...
    function (queryId, meta, next) {
      ...
      var request = new requests.ExecuteWriter(
        queryId,
        params,
        options);
      request.query = query;
...
Client.prototype.batch = function () {
  ...
  var request = new requests.BatchWriter(args.queries, args.options.consistency, args.options);
...
Client.prototype._getPrepared = function (query, callback) {
  ...
  info.preparing = true;
  var request = new requests.PrepareQueryWriter(query);
  var handler = new RequestHandler(this, this.options);
