...
Client.prototype.execute = function (query, params, options, callback) {
  ...
  if (typeof callback === 'function') {
    ...
    return promiseUtils.toCallback(this._execute(query, params, execOptions), callback);
  }
  ...
  return this._execute(query, params, execOptions);
};
 ...
 * @private
 */
Client.prototype._createQueryRequestAsync = async function (query, execOptions, params) {
