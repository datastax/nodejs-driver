 ...
 * @param {function} callback
 */
Connection.prototype.executeBatch = function (queries, options, consistency, callback) {
  this.sendStream(new writers.BatchWriter(queries, options, consistency), options, callback);
};
