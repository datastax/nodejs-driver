...
Connection.prototype.startup = function (callback) {
  ...
  var self = this;
  this.sendStream(new requests.StartupWriter(), null, function (err, response) {
...
Connection.prototype.changeKeyspace = function (keyspace, callback) {
  ...
  var self = this;
  this.sendStream(
    new requests.QueryWriter(query, null, null),
    null,
    function (err) {
      if (!err) {
...
Connection.prototype.prepareOnce = function (query, callback) {
  ...
  var self = this;
  this.sendStream(new requests.PrepareQueryWriter(query), null, function (err, response) {
...
Connection.prototype.getWriteCallback = function (frameWriter, options, callback){
  ...
  return (function writeCallback (err) {
    ...
    if (frameWriter instanceof requests.ExecuteWriter || frameWriter instanceof requests.QueryWriter) {
