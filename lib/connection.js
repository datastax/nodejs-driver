...
Connection.prototype.open = function (callback) {
  var self = this;
  self.log('info', 'Connecting to ' + this.address + ':' + this.port);
  self.createSocket();
...
Connection.prototype.sendStream = function (frameWriter, options, callback) {
  ...
  if (streamId === null) {
    ...
    return this.pendingWrites.push({frameWriter: frameWriter, options: options, callback: callback});
  }
  if (!callback) {
  ...
  this.writeQueue.push(frameWriter, this.getWriteCallback(frameWriter, options, callback));
};
...
Connection.prototype.writeNext = function () {
  ...
  setImmediate(function writeNextPending() {
    ...
    self.sendStream(pending.frameWriter, pending.options, pending.callback);
  });
};
