...
class ControlConnection extends events.EventEmitter {
   ...
   */
  async borrowFirstConnection(contactPointsIterator) {
    let connection = null;
    ...
    while (!connection) {
      ...
      try {
        connection = await this.createConnection(contactPoint);
      } catch (err) {
  ...
  async initializeConnection() {
    ...
    while (true) {
      await this.borrowFirstConnection(contactPointsIterator);
