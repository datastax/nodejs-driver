...
async function refreshMetadataServiceInfo(options) {
  ...
  // Note that we're assuming parseZipFile() has already been called and thus
  // relevant options have been set
  await getMetadataServiceInfoAsync(cloudOptions);
}
