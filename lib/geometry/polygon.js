 ...
 * @param [arguments] The sequence of Array of {@link Point} items as arguments representing the rings of the polygon.
 * @example
...
Polygon.fromBuffer = function (buffer) {
  ...
  offset += 4;
  var ringsLength = Geometry.readInt32(buffer, endianness, offset);
  offset += 4;
  var ringsArray = new Array(ringsLength);
  for (var ringIndex = 0; ringIndex < ringsLength; ringIndex++) {
    var pointsLength = Geometry.readInt32(buffer, endianness, offset);
    offset += 4;
...
Polygon.prototype.toBuffer = function () {
  ...
  var buffer = new Buffer(9 + totalRingsLength);
...
Polygon.prototype.isOSBE = function () {
