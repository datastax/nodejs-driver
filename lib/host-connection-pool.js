...
class HostConnectionPool extends events.EventEmitter {
  ...
  constructor(host, protocolVersion) {
    ...
    // Use _creating and _opening as both a flag and the actual promise of the async task
    this._creating = null;
    this._opening = null;
    this._host = host;
  ...
  async createAndBorrowConnectionAsync(keyspace) {
    ...
    await this.borrowConnectionAsync(keyspace, null);
  }
  ...
  async createAsync(warmup) {
    ...
    this._creating = promiseUtils.fromEvent(this, 'creation');
  ...
  async _attemptNewConnectionAsync() {
    ...
    this._opening = promiseUtils.fromEvent(this, 'open');
