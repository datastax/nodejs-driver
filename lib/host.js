 ...
 * @ignore
 */
Host.prototype.borrowConnection = function(previousConnection) {
 ...
 * @ignore
 */
Host.prototype.warmupPool = function (keyspace) {
 ...
 * @ignore
 */
Host.prototype.initializePool = function () {
...
Host.prototype._onNewConnectionOpen = async function (err) {
  ...
  //TODO: Use think about execution or include comment
  this.pool.increaseSize();
};
