...
class ModelMapper {
   ...
   * @param {Number} [executionOptions.consistency] The [Consistency level]{@link module:types~consistencies} of the
   * operation.
  ...
  /**
   * Executes a SELECT query based without a filter and returns the result as an iterable of documents.
   * <p>
