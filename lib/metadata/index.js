 ...
 * @private
 */
Metadata.prototype._refreshKeyspace = async function (name) {
  if (!this.initialized) {
 ...
 * @internal
 */
Metadata.prototype.refreshKeyspacesInternal = async function (waitReconnect) {
 ...
 * @private
 */
Metadata.prototype._getUdt = async function (keyspaceName, name) {
  if (!this.initialized) {
    throw this._uninitializedError();
  }
 ...
 * @private
 */
Metadata.prototype._getTable = async function (keyspaceName, name) {
  if (!this.initialized) {
    throw this._uninitializedError();
  }
 ...
 * @private
 */
Metadata.prototype._getFunctionsWrapper = async function (keyspaceName, name) {
 ...
 * @private
 */
Metadata.prototype._getAggregates = async function (keyspaceName, name) {
  if (!keyspaceName || !name) {
 ...
 * @private
 */
Metadata.prototype._getMaterializedView = async function (keyspaceName, name) {
  if (!this.initialized) {
    throw this._uninitializedError();
  }
 ...
 * @private
 */
Metadata.prototype._getFunctions = async function (keyspaceName, name, aggregate) {
  if (!this.initialized) {
    throw this._uninitializedError();
  }
 ...
 * @private
 */
Metadata.prototype._getSingleFunction = async function (keyspaceName, name, signature, aggregate) {
  if (!keyspaceName || !name) {
    throw new errors.ArgumentError('You must provide the keyspace name and cql function name to retrieve the metadata');
  }
 ...
 * @private
 */
Metadata.prototype._checkSchemaAgreement = async function () {
 ...
 * @ignore
 */
Metadata.prototype.adaptUserHints = async function (keyspace, hints) {
 ...
 * @ignore
 */
Metadata.prototype.compareSchemaVersions = async function (connection) {
