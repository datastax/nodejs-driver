...
SchemaParser.prototype.getTable = function (cc, keyspace, name, callback) {
  ...
  async.waterfall([
    ...
    try {
      self._parseTableOrView(tableInfo, cc.getEncoder(), tableRow, columnRows);
    }
    catch (parseError) {
      err = parseError;
    }
 ...
 * @throws {Error}
 */
SchemaParser.prototype._parseTableOrView = function (tableInfo, encoder, tableRow, columnRows) {
};
...
/** @override */
SchemaParserV1.prototype._parseTableOrView = function (tableInfo, encoder, tableRow, columnRows) {
  var i, c, name, types;
  var columnsKeyed = {};
  var partitionKeys = [];
  var clusteringKeys = [];
...
/** @override */
SchemaParserV2.prototype._parseTableOrView = function (tableInfo, encoder, tableRow, columnRows) {
  var i, c;
  var columnsKeyed = {};
  var partitionKeys = [];
  var clusteringKeys = [];
  ...
  tableInfo.crcCheckChance = tableRow['crc_check_chance'] || 1;
  tableInfo.columnsByName = columnsKeyed;
  if (isView) {
