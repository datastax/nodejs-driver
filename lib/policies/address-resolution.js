 ...
 * @param {String} address the address of a node as returned by Cassandra. Note that
 * if the <code>rpc_address</code> of a node has been configured to <code>0.0.0.0</code>
 ...
 * @returns {String} The Ip address and the port in the format <code>ipAddress:port</code>.
 */
AddressTranslator.prototype.translate = function (address, port) {
  return address + ':' + port;
};
