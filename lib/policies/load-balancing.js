...
function setLocalDc(lbp, client, hosts) {
  ...
  if (client && client.options) {
    if (lbp.localDc && !client.options.localDataCenter) {
      client.log('info', 'Local data center \'' + lbp.localDc + '\' was provided as an argument to the' +
        ' LoadBalancingPolicy. It is more preferable to specify the local data center using \'localDataCenter\'' +
