...
class RequestHandler {
  ...
  static borrowNextConnection(iterator, triedHosts, profileManager, keyspace, callback) {
    ...
    const host = RequestHandler.getNextHost(iterator, profileManager, triedHosts);
    if (host === null) {
...
RequestHandler.sendAsync = util.promisify(RequestHandler.send);
