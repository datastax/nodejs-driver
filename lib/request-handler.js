...
RequestHandler.prototype.prepareMultiple = function (queries, callbacksArray, options, callback) {
  ...
  this.getNextConnection(options, function (err, c) {
    ...
    self.connection = c;
    self.prepareOnConnection(queries, callbacksArray, options, callback);
  });
};

/**
 * Serially prepares multiple queries on the current connection
 * @param {Array.<string>} queries
 * @param {Array.<function>} [callbacksArray]
 * @param {QueryOptions} options
 * @param {function} callback
 */
RequestHandler.prototype.prepareOnConnection = function (queries, callbacksArray, options, callback) {
  var self = this;
  var index = 0;
