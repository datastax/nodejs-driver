...
Murmur3Tokenizer.prototype.hash2 = function hash2(value) {
  ...
  switch(length & 15) {
    ...
    case 1:
      k1 = k1.xor(new MutableLong(data[offset]));
      k1 = k1.multiply(mconst1);
      this.rotl642(k1,31);
      k1 = k1.multiply(mconst2);
      h1 = h1.xor(k1);
...
// 0xff51afd7ed558ccd
var mconst7 = new MutableLong(0x8ccd, 0xed55, 0xafd7, 0xff51);
//0xc4ceb9fe1a85ec53
var mconst8 = new MutableLong(0xec53, 0x1a85, 0xb9fe, 0xc4ce);
