...
Murmur3Tokenizer.prototype.getBlock = function (key, offset, index) {
  ...
  return (
    ...
    Long.fromNumber(key[blockOffset + 1] & 0xff).shiftLeft(8) +
    Long.fromNumber(key[blockOffset + 2] & 0xff).shiftLeft(16) +
    Long.fromNumber(key[blockOffset + 3] & 0xff).shiftLeft(24) +
    Long.fromNumber(key[blockOffset + 4] & 0xff).shiftLeft(32) +
    Long.fromNumber(key[blockOffset + 5] & 0xff).shiftLeft(40) +
    Long.fromNumber(key[blockOffset + 6] & 0xff).shiftLeft(48) +
    Long.fromNumber(key[blockOffset + 7] & 0xff).shiftLeft(56)
    );
};
