 ...
 * @returns {FrameHeader}
 */
FrameHeader.fromBuffer = function (version, buf) {
  var streamId = 0;
  var offset = 0;
  if (version < 3) {
  ...
  var instance = new FrameHeader(version, buf.readUInt8(1), streamId, buf.readUInt8(offset++), buf.readUInt32BE(offset));
  instance.isResponse = buf[0] & 0x80;
  if (instance.version != (buf[0] & 0x7F)) {
