...
// In some cases we'll want to provide JavaScript objects as values for fields of
// type vector.  Ideally we'd just use an Array for the corresponding JavaScript
// object (since the mapping is fairly straightforward) but the driver already 
// assigns arrays in such cases to the list type.  To work around this we create
// a custom subclass of Array to represent vector data.
class CqlVector extends Array {}
