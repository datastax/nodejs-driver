...
function MutableLong(b00, b16, b32, b48) {
  //this._arr = new Uint16Array([ b00 || 0, b16 || 0, b32 || 0, b48 || 0 ]);
  this._arr = [ b00 || 0, b16 || 0, b32 || 0, b48 || 0 ];
  //this._arr = new Buffer(4);
}
...
MutableLong.prototype.not = function () {
  this._arr[0] = ~this._arr[0];
  this._arr[1] = ~this._arr[1];
  this._arr[2] = ~this._arr[2];
  this._arr[3] = ~this._arr[3];
  return this;
};
...
MutableLong.prototype.shiftRightUnsigned = function (numBits) {
  ...
  if (remainingBits > 0) {
    this._arr[0] = this._arr[0] >>> remainingBits;
    this._arr[1] = this._arr[1] >>> remainingBits;
    this._arr[2] = this._arr[2] >>> remainingBits;
    this._arr[3] = this._arr[3] >>> remainingBits;
  }
  return this;
};

MutableLong.prototype.getFirstByte = function () {
  return this._arr[0] & 0xff;
};
...
MutableLong.prototype._shiftLeftBits = function (numBits) {
  this._arr[3] = (this._arr[3] << numBits) | (this._arr[2] >>> (16 - numBits));
  this._arr[2] = (this._arr[2] << numBits) | (this._arr[1] >>> (16 - numBits));
  this._arr[1] = (this._arr[1] << numBits) | (this._arr[0] >>> (16 - numBits));
  this._arr[0] = this._arr[0] << numBits;
  return this;
};
