...
/**
 * Internal method used to set the schema agreement flag.
 * @param {Boolean|undefined} value
 * @ignore
 */
ResultSet.prototype.setSchemaAgreement = function (value) {
  if (value === undefined) {
    // Information about schema versions could not be retrieved
    return;
  }
  this.info.isSchemaInAgreement = value;
};
