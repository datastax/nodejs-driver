...
class ResultSet {
  ...
  columns: Array<{ name: string, type: { code: typeof dataTypes, info: any } }>;
  nextPage: (() => void) | null;
  pageState: string;
  rowLength: number;
  rows: Row[];
   ...
   * @constructor
   */
  constructor(response: { rows: Array<any>, flags: { traceId: Uuid, warnings: string[], customPayload: any }, meta?: { columns: Array<{ name: string, type: { code: typeof dataTypes, info: any } }>, pageState: Buffer } }, host: string, triedHosts: { [key: string]: any; }, speculativeExecutions: number, consistency: typeof consistencies, isSchemaInAgreement: boolean) {
