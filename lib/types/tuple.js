 ...
 */
function Tuple() {
  this._elements = Array.prototype.slice.call(arguments);
  if (this._elements.length === 0) {
    throw new TypeError('Tuple must contain at least one value');
  }
  if (this._elements.length === 1 && util.isArray(this._elements)) {
  ...
  /**
   * Returns the elements in Tuple.
   * @name elements
   * @memberof module:types~Tuple#
   */
 Object.defineProperty(Tuple.prototype, 'elements', { 
  set: function() {
    throw Error("Cannot change value of elements in Tuple");
  },
  get: function () { 
   ...
   * @memberof module:types~Tuple#
   */
  Object.defineProperty(Tuple.prototype, 'length', { get: function () { return this.elements.length; }, enumerable: false });

// Object.defineProperty(InetAddress.prototype, 'length', {get: function () { return this.buffer.length; }, enumerable: true});
