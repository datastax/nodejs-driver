...
/**
 * Reset the first row of the stacktrace to the name of
 * the Error
 */
function fixStack(stackTrace, error) {
  error.readStack = error.stack;
  var functions = stackTrace.substr(stackTrace.indexOf("\n") + 1);
