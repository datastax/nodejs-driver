...
/**
 * Request to ask the server to return what STARTUP options are supported
 * @constructor
 */
...
OptionsRequest.prototype.write = function () {
  var frameWriter = new FrameWriter(types.opcodes.options);
  return frameWriter.write(this.version, this.streamId);
};
