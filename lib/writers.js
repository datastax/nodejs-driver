...
FrameWriter.prototype.writeLong = function(num) {
  this.buffers.push(types.Long.toBuffer(num));
};
...
FrameWriter.prototype.write = function(version, streamId) {
  var bodyBuffer = Buffer.concat(this.buffers);
  var header = new FrameHeader(version, 0, streamId, this.opcode, bodyBuffer.length);
