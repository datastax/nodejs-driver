...
function QueryWriter(query, params, consistency, pageSize, pageState) {
  this.query = query;
  this.params = params;
  this.consistency = consistency || types.consistencies.one;
 ...
 */
function ExecuteWriter(queryId, params, consistency, pageSize, pageState) {
...
function BatchWriter(queries, consistency, options) {
  ...
  this.consistencies = consistency;
  this.streamId = null;
  if (consistency === null || typeof consistency === 'undefined') {
    this.consistencies = types.consistencies.getDefault();
  }
}
...
BatchWriter.prototype.write = function () {
  ...
  frameWriter.writeShort(this.consistencies);
  return frameWriter.write();
};
/**
