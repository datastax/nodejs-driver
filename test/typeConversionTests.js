...
module.exports = {
  ...
  encodeParamsTest: function (test) {
    ...
    test.ok(queryParser.encodeParam(new Date('Tue, 13 Aug 2013 09:10:32 GMT')) === '1376385032000', 'Encodeparam for Date failed: ' + queryParser.encodeParam(new Date('Tue, 13 Aug 2013 09:10:32 GMT')));
    test.done();
  },
